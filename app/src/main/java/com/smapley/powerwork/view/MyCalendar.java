package com.smapley.powerwork.view;
 ...
 */
public class MyCalendar extends ViewFlipper implements
        android.view.GestureDetector.OnGestureListener {
    public static final int COLOR_TX_WEEK = Color.parseColor("#505050"); // 星期标题文字颜色
    public static final int COLOR_TX_THIS_MONTH_DAY = Color
            .parseColor("#505050"); // 当前月日历数字颜色
    public static final int COLOR_TX_OTHER_MONTH_DAY = Color
            .parseColor("#aaaaaa"); // 其他月日历数字颜色cde4fa
    public static final int size = 15;// 字体大小
    ...
    private void drawFrame(LinearLayout oneCalendar) {
        ...
        //  title.setBackgroundResource(R.drawable.rili_bg1);
        ...
        for (int i = 0; i < COLS_TOTAL; i++) {
            ...
            view.setTextColor(COLOR_TX_WEEK);
        ...
        for (int i = 0; i < ROWS_TOTAL; i++) {
            ...
            for (int j = 0; j < COLS_TOTAL; j++) {
                ...
                //    col.setBackgroundResource(R.drawable.rili_bg0);
                row.addView(col);
                // 给每一个日子加上监听
                col.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (onCalendarClickListener != null) {
                            onCalendarClickListener.onCalendarClick(v, row, col,
                                    dates[row][col]);
                        }
                ...
                if (i == 0 && j == 0 && weekday != 0) {
                    ...
                    if (day <= lastDay) {
                        ...
                        if (thisday.getDate() == day
                            ...
                            if (dayBgColorMap.size() == 0) {
                                dayBgColorMap.put(dates[i][j], R.mipmap.cal_iv_nowday);
                            }
                        }
    ...
    public interface OnCalendarClickListener {
        void onCalendarClick(View view, int row, int col, String dateFormat);
    }
